...
50/50 = 100.0% — **PASS** (threshold ≥70%, live records only). Excluded 0 stale-sha and 0 stub record(s).

## F2 — semantic coverage

Mean tag-coverage **97.0%** vs decoy baseline **49.0%** (shift-by-one derangement) — **PASS** (threshold ≥70% AND strictly above decoy). 50 fusion(s) had ≥1 mappable tag.
...
| beacon | 2 | 1/1 (100.0%) | — |
| blaze | 2 | 3/3 (100.0%) | — |
| branded-glyph | 2 | 2/2 (100.0%) | — |
| briar-patch | 2 | 3/3 (100.0%) | — |
| brushfire | 2 | 3/3 (100.0%) | — |
| cairn | 2 | 1/1 (100.0%) | — |
| cairn | 2 | 2/2 (100.0%) | — |
| cauterize | 2 | 2/2 (100.0%) | — |
| cauterizing-light | 2 | 1/1 (100.0%) | — |
| cinder | 3 | 3/3 (100.0%) | — |
| cinder-drift | 2 | 2/2 (100.0%) | — |
| cinder-scar | 2 | 2/2 (100.0%) | — |
| cipher | 2 | 2/2 (100.0%) | — |
| current | 2 | 2/2 (100.0%) | — |
| dew | 2 | 1/1 (100.0%) | — |
| dust-devil | 2 | 3/3 (100.0%) | — |
| dust-devil | 2 | 2/2 (100.0%) | — |
| eclipse-cut | 2 | 2/2 (100.0%) | — |
| geyser | 2 | 2/2 (100.0%) | — |
| glint | 2 | 0/1 (0.0%) | movement |
| hearth-stone | 2 | 2/2 (100.0%) | — |
| inscription | 2 | 1/1 (100.0%) | — |
| lighthouse | 3 | 2/2 (100.0%) | — |
| lodestone | 3 | 1/1 (100.0%) | — |
| mist | 2 | 2/2 (100.0%) | — |
| mist | 2 | 2/2 (100.0%) | — |
| mud | 2 | 1/2 (50.0%) | ward |
| mudslide | 2 | 3/3 (100.0%) | — |
| murk | 2 | 3/3 (100.0%) | — |
| murk | 2 | 3/3 (100.0%) | — |
| murk | 2 | 2/2 (100.0%) | — |
...
| salve | 2 | 2/2 (100.0%) | — |
| scar | 2 | 2/2 (100.0%) | — |
| scrying-pool | 2 | 1/1 (100.0%) | — |
| seagrass | 2 | 2/2 (100.0%) | — |
| smoke | 2 | 3/3 (100.0%) | — |
| snare | 2 | 3/3 (100.0%) | — |
| snare | 2 | 1/1 (100.0%) | — |
| spotlight | 2 | 1/1 (100.0%) | — |
| squall | 2 | 3/3 (100.0%) | — |
| squall | 2 | 3/3 (100.0%) | — |
| steam | 2 | 2/2 (100.0%) | — |
| tangle | 2 | 3/3 (100.0%) | — |
| warding-stone | 2 | 1/1 (100.0%) | — |
| warding-wind | 2 | 2/2 (100.0%) | — |
| wildfire | 2 | 2/2 (100.0%) | — |

## Quantization pressure (unmappable tags demanded)

perceive=18  (18 fusion(s) carried ≥1 unmappable tag — the widening signal, by design).
