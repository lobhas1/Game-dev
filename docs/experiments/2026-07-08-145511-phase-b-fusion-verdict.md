...
Mean tag-coverage **95.8%** vs decoy baseline **46.7%** (shift-by-one derangement) — **PASS** (threshold ≥70% AND strictly above decoy). 20 fusion(s) had ≥1 mappable tag.
...
perceive=7  (7 fusion(s) carried ≥1 unmappable tag — the widening signal, by design).
